...
#For Office 2024 Retail.
    ...
    if (($dstatus | Select-String -SimpleMatch "Office24Professional" | Measure-Object).Count -gt 0 -and $matchingOffice2024Retail -gt 0 ) {$licName = 'ProPlus2024VL*'; $2024kmskey = 'XJ2XN-FW8RK-P4HMP-DKDBV-GCVGB'; Office2024-V2R} #For Office 2024 Retail (Pro)
    if (($dstatus | Select-String -SimpleMatch "Office24ProPlus" | Measure-Object).Count -gt 0 -and $matchingOffice2024Retail -gt 0 ) {$licName = 'ProPlus2024VL*'; $2024kmskey = 'XJ2XN-FW8RK-P4HMP-DKDBV-GCVGB'; Office2024-V2R} #For Office 2024 Retail (Pro) (MSDN)
    if (($dstatus | Select-String -SimpleMatch "Office24Standard" | Measure-Object).Count -gt 0 -and $matchingOffice2024Retail -gt 0 ) {$licName = 'Standard2024VL*'; $2024kmskey = 'V28N4-JG22K-W66P8-VTMGK-H6HGR'; Office2024-V2R} #For Office 2024 Retail (Standard)
    if (($dstatus | Select-String -SimpleMatch "Office24ProjectPro" | Measure-Object).Count -gt 0 -and $matchingOffice2024Retail -gt 0 ) {$licName = 'ProjectPro2024VL*'; $2024kmskey = 'FQQ23-N4YCY-73HQ3-FM9WC-76HF4'; Office2024-V2R} #For Office 2024 Standalone (Project Pro)
    if (($dstatus | Select-String -SimpleMatch "Office24ProjectStd" | Measure-Object).Count -gt 0 -and $matchingOffice2024Retail -gt 0 ) {$licName = 'ProjectStd2024VL*'; $2024kmskey = 'PD3TT-NTHQQ-VC7CY-MFXK3-G87F8'; Office2024-V2R} #For Office 2024 Standalone (Project Standard)
    if (($dstatus | Select-String -SimpleMatch "Office24VisioPro" | Measure-Object).Count -gt 0 -and $matchingOffice2024Retail -gt 0 ) {$licName = 'VisioPro2024VL*'; $2024kmskey = 'B7TN8-FJ8V3-7QYCP-HQPMV-YY89G4'; Office2024-V2R} #For Office 2024 Standalone (Visio Pro)
    if (($dstatus | Select-String -SimpleMatch "Office24VisioStd" | Measure-Object).Count -gt 0 -and $matchingOffice2024Retail -gt 0 ) {$licName = 'VisioStd2024VL*'; $2024kmskey = 'JMMVY-XFNQC-KK4HK-9H7R3-WQQTV'; Office2024-V2R} #For Office 2024 Standalone (Visio Standard)
    if (($dstatus | Select-String -SimpleMatch "Office24Word" | Measure-Object).Count -gt 0 -and $matchingOffice2024Retail -gt 0 ) {$licName = 'Word2024VL*'; $2024kmskey = 'MQ84N-7VYDM-FXV7C-6K7CC-VFW9J'; Office2024-V2R} #For Office 2024 Standalone (Word)
    if (($dstatus | Select-String -SimpleMatch "Office24Excel" | Measure-Object).Count -gt 0 -and $matchingOffice2024Retail -gt 0 ) {$licName = 'Excel2024VL*'; $2024kmskey = 'F4DYN-89BP2-WQTWJ-GR8YC-CKGJG'; Office2024-V2R} #For Office 2024 Standalone (Excel)
    if (($dstatus | Select-String -SimpleMatch "Office24PowerPoint" | Measure-Object).Count -gt 0 -and $matchingOffice2024Retail -gt 0 ) {$licName = 'PowerPoint2024VL*'; $2024kmskey = 'CW94N-K6GJH-9CTXY-MG2VC-FYCWP'; Office2024-V2R} #For Office 2024 Standalone (PowerPoint)
    if (($dstatus | Select-String -SimpleMatch "Office24Outlook" | Measure-Object).Count -gt 0 -and $matchingOffice2024Retail -gt 0 ) {$licName = 'Outlook2024VL*'; $2024kmskey = 'D2F8D-N3Q3B-J28PV-X27HD-RJWB9'; Office2024-V2R} #For Office 2024 Standalone (Outlook)
    if (($dstatus | Select-String -SimpleMatch "Office24Access" | Measure-Object).Count -gt 0 -and $matchingOffice2024Retail -gt 0 ) {$licName = 'Access2024VL*'; $2024kmskey = '82FTR-NCHR7-W3944-MGRHM-JMCWD'; Office2024-V2R} #For Office 2024 Standalone (Access)
...
#For Office 2016 Retails
    ...
    if (($dstatus | Select-String -SimpleMatch "Office16Publisher" | Measure-Object).Count -gt 0 -and $matchingOffice2016Retail -gt 0 ) {$licName = 'PublisherVL*'; $2016kmskey = 'F47MM-N3XJP-TQXJ9-BP99D-8K837'; Office2016-V2R} #For Office 2016 Standalone (Publisher)
...
#For Office 2013 Retail.
    function Office2013-V2R {
        Write-Host "Converting from Retail to Volume..." -ForegroundColor Green
        $inslics = Get-ChildItem -Path "$env:temp\tmp\library\$licName"
        foreach ($inslic in $inslics){
            cscript ospp.vbs /inslic:"$env:temp\tmp\library\$licName\$($inslic.Name)" | Out-Null
        }
