    ...
    <Grid Width="1045" Height="480" VerticalAlignment="Top">
        <GroupBox x:Name="groupBoxMicrosoftOffice" Header="Select a edition to conversion:" FontFamily="Consolas" FontSize="11" Width="1025" Height="440" VerticalAlignment="Top" Margin="0,10,0,0" BorderBrush="#FF164A69">
            <Canvas HorizontalAlignment="Left">
                ...
                <Label x:Name="Label2016" Content="SERVER 2016" FontWeight="Bold" Canvas.Left="484" Background="#FF051B74" Canvas.Top="8" HorizontalAlignment="Left" VerticalAlignment="Center" Foreground="White" Padding="8,4,8,4"/>
                ...
                <Label x:Name="Label10" Content="WINDOWS 10" FontWeight="Bold" Canvas.Left="650" Background="#FF2349E2" Canvas.Top="8" HorizontalAlignment="Left" VerticalAlignment="Center" Padding="8,4,8,4" Foreground="White"/>
                ...
                <Label x:Name="Label11" Content="WINDOWS 11" FontWeight="Bold" Canvas.Left="835" Background="#FF2349E2" Canvas.Top="8" VerticalAlignment="Center" Foreground="White" Padding="8,4,8,4" HorizontalAlignment="Left" BorderThickness="1,1,1,1"/>
